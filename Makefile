# This Makefile is for the Term::SimpleColor extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Term/SimpleColor.pm]
#     AUTHOR => [q[Takashi Uesugi <tksuesg@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Term/SimpleColor.pm
...
TO_INST_PM = lib/Term/SimpleColor.pm

PM_TO_BLIB = lib/Term/SimpleColor.pm \
...
DISTVNAME = Term-SimpleColor-0.0.3
...
manifypods : pure_all  \
	lib/Term/SimpleColor.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Term/SimpleColor.pm $(INST_MAN3DIR)/Term::SimpleColor.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Term-SimpleColor' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Term-SimpleColor",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Term/SimpleColor.pm blib/lib/Term/SimpleColor.pm 
